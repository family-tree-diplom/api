...
namespace OpenCCK\Infrastructure\EventDispatcher;

use OpenCCK\App\Event\EventInterface;
...
final class EventDispatcher implements EventDispatcherInterface {
     ...
     * @see EventDispatcherTest::testEventDispatch()
     * @see EventDispatcherTest::testStopPropagation()
     */
